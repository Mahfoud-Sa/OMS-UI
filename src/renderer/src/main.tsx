...
// Initialize Sentry at the very top of your renderer entry point
Sentry.init({
  ...
  release: window.electron.ipcRenderer.sendSync('get-app-version'),
  environment: import.meta.env.RENDERER_VITE_REACT_APP_ENV,
