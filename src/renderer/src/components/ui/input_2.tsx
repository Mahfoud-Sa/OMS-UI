    ...
    return (
      <div className="group relative max-w-full text-right text-on-surface-variant">
        <input
          ...
          {...props}
        />
        <label className="pointer-events-none bg-[white] absolute right-[9px] top-px -translate-y-[55%] transform px-1 text-[12px] font-medium peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-base">
          {label}
        </label>
      </div>
    )
