...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-0 left-1/2 transform -translate-x-1/2 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:top-0 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:bottom-auto sm:flex-col md:max-w-[420px]',
      className
    )}
    {...props}
  />
...

  {
    variants: {
      variant: {
        ...
        success: 'border bg-green-500 text-white' // استخدام Tailwind CSS على سبيل المثال للون الأخضر
      }
    },
    defaultVariants: {
      variant: 'default'
